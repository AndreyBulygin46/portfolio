'''Условие задачи
В этом задании вы сделаете мини-анализ данных.
...
indexes_d = [course_index[1] for course_index in duration_index] 
indexes_m = [mc_index[1] for mc_index in mcount_index]
...
print("Связь есть" if indexes_d in indexes_m else "Связи нет")
