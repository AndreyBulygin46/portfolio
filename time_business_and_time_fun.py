'''Условие задачи
Подсчитайте, сколько времени в часах у вас останется на перерывы, когда вы сделаете все задачи из todo_list, если рабочий день длится 8 часов. 
...
def solve(todo_list: list, workday: float = 8):
    worktime = 0.0
    for todo,time in todo_list: # посчитайте в цикле сумму рабочего времени и сохраните в переменную worktime
        worktime += time
